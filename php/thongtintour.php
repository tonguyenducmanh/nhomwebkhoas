...
<body>
            ...
            <!-- phần header trên cùng của trang web, gồm logo, menu và liên hệ mxh-->
                ...
                <div class="header-menu">
                    <ul class="header-menu-list">
                        ...
                        <li><a href="thongtintour.php">Lướt xem Tour</a></li>
        ...
        <div class="main-container">
            ...
            <div class="box-text-group">
                ...
                <div class="box-menu-text-one">
                    <a href="thongtintour.php#ngay1">Ngày 1</a>
                    <a href="thongtintour.php#ngay2">Ngày 2</a>
                    <a href="thongtintour.php#ngay3">Ngày 3</a>
                    <a href="thongtintour.php#ngay4">Ngày 4</a>
                    <a href="thongtintour.php#ngaycuoi">Ngày cuối</a>
                </div>
            </div>
    ...
    <!--file này dùng chung script chạy cuộn menu như file thongtindiadiem.php-->
</body>
</html>